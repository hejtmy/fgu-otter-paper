...
write.csv(df_individual_results, "individual-results.csv", row.names = FALSE)
```
...
for(i in 1:nrow(df_request)){
  ...
  print(plot_area_presence(contextA, scale = 100, colors = c("blue", "yellow")) +
          guides(fill="none") + 
          ggtitle(line$code, subtitle = "Context A"))
  print(plot_area_presence(contextB, scale = 100, colors = c("blue", "yellow")) +
          guides(fill="none") + 
