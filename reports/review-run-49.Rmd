...
all_data <- data_run49
codingtables <- codingtables_run49
df_files <- df_files_run49
rm(data_run49, codingtables_run49, df_files_run49)
```
...
for(code in names(all_data)){
  ...
  print(paper_heatmap(contextA, "A") +
          ggtitle(code, subtitle = "Context A"))
  print(paper_heatmap(contextB, "B") +
